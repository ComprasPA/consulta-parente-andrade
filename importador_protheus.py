...
Mesmas regras de sempre: dedup por chave; campo de data (ENTREGA) prevalece
o que vier no arquivo (mesmo que ja tenha valor - o arquivo mais recente do
Totvs e a fonte de verdade); os demais campos so preenchem em branco (nunca
sobrescrevem o que ja tem valor); status so muda quando esta "em espera"
(branco/Em aprovacao/Pendente) - EXCETO que ENTREGA ganhar uma data sempre
forca o Status pra "ATENDIDO"."""
